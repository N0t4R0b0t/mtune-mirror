...
#
#     bash -c "$(curl -fsSL https://raw.githubusercontent.com/<you>/customArchForArch/main/install.sh)"
#
...
REPO_URL="${REPO_URL:-https://github.com/N0t4R0b0t/customArchForArch.git}"
